...
//import org.tearne.crosser.spike.DBWriter
//
...
//		
//		//Write to DB
//		val crosses = scheme.crosses.values
//		val dbWriter = new DBWriter(scheme, 1)
//		dbWriter.writeDistribution(crossSamplerService.getDistributionFor(crosses.last))
//		
//		
//		System.exit(0)
//		
